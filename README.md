...
```
# Pull, index, and push a Fedora 42 snapshot to a local directory:
rpmrepo --cache /tmp/rpmrepo --local f42-fedora pull \
    --platform-id f42 \
    --base-url "https://dl01.fedoraproject.org/pub/fedora/linux/releases/42/Everything/x86_64/os/"

rpmrepo --cache /tmp/rpmrepo --local f42-fedora index

rpmrepo --cache /tmp/rpmrepo --local f42-fedora push \
    --output /srv/rpmrepo \
    --to data public f42 \
    --to snapshot f42-x86_64-fedora -20260216
```
